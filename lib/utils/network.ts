...
export const EXPLORER_URLS = {
  ...
  [CHAIN_IDS.HEDERA_MAINNET]: 'https://hashscan.io/mainnet',
  [CHAIN_IDS.HEDERA_TESTNET]: 'https://hashscan.io/testnet',
  [CHAIN_IDS.HARDHAT]: '',
} as const;
...
export function getUsdtAddress(chainId?: number): `0x${string}` {
  ...
  switch (id) {
    ...
    case CHAIN_IDS.HEDERA_MAINNET:
      // USDT on Hedera Mainnet
      return '0x0000000000000000000000000000000000000000';
    case CHAIN_IDS.CRONOS_ZKEVM:
      return '0x0000000000000000000000000000000000000000';
    default:
