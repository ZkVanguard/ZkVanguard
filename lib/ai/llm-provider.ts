...
function shouldCacheQuery(message: string): boolean {
...
function getCachedLLMResponse(promptHash: string): LLMResponse | null {
...
function setCachedLLMResponse(promptHash: string, response: LLMResponse): void {
