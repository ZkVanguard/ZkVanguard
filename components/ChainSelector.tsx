              ...
              >
                ...
                <div className={`w-10 h-10 rounded-full flex items-center justify-center ${
                  chain.type === 'evm' 
                    ...
                    : chain.type === 'hedera'
                    ? 'bg-gradient-to-r from-[#8259EF] to-[#5B2CC2]'
                  ...
                  {chain.type === 'evm' ? (
                    ...
                    <span className="text-white font-bold text-sm">HBAR</span>
                ...
                <div className="flex-1 text-left">
                  ...
                  <div className="text-[#86868B] text-xs">
                    {chain.type === 'evm' ? 'EVM Compatible • x402 Gasless'
                      : chain.type === 'hedera' ? 'Hashgraph • Pyth Oracles'
                ...
                <div className={`px-2 py-1 rounded-full text-xs font-medium ${
                  chain.type === 'evm'
                    ...
                    : chain.type === 'hedera'
                    ? 'bg-[#8259EF]/10 text-[#8259EF]'
                    : chain.type.startsWith('oasis')
                    ? 'bg-[#0092F6]/10 text-[#0092F6]'
                    : 'bg-[#32ADE6]/10 text-[#32ADE6]'
                }`}>
                  {chain.type === 'evm' || chain.type === 'hedera' ? 'Live' : 'Ready'}
                </div>
